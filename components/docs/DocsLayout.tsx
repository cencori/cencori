...
export function DocsLayout({ children, className }: DocsLayoutProps) {
    ...
    return (
        <div className="mx-auto w-full max-w-[1440px] flex flex-col md:flex-row justify-center gap-4 md:gap-5 lg:gap-6 px-4 md:px-8 lg:px-12">
            <div className="hidden md:block w-[280px] xl:w-[300px] shrink-0">
                <DocsSidebar />
            </div>
            <main className={cn("w-full max-w-3xl pt-20 lg:pt-24 pb-10 lg:pb-14", className)}>
                {children}
            </main>
            {!isAskAIOpen && (
