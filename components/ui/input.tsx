  ...
  return (
    <input
      ...
      className={cn(
        ...
        "autofill:bg-background autofill:text-foreground [-webkit-autofill]:bg-background [-webkit-autofill]:text-foreground [-webkit-autofill]:shadow-[0_0_0_1000px_hsl(var(--background))_inset] [-webkit-autofill]:[-webkit-text-fill-color:hsl(var(--foreground))]",
        "focus-visible:border-border focus-visible:ring-[1px] focus-visible:ring-ring/20",
