  ...
  return (
    ...
    >
      ...
      <div
        ...
        tabIndex={0}
        className={cn(
          'text-[0.8125rem] py-4 px-4 overflow-auto max-h-[600px] fd-scroll-container focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-fd-ring',
...
// Custom useCopyButton hook
function useCopyButton(onCopy: () => void): [boolean, () => void] {
