-- Repair migration: replays working-tree fixes to 000009 that were
-- pushed before they were made. Idempotent; safe to run once.
--
-- 1. NULL-safe skills visibility backfill (NULL slipped the old predicates).
...
-- 2. Claim function with timeout return + null-safe conflict handler.
