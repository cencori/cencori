...
Once connected, custom providers go through the same gateway pipeline as OpenAI, Anthropic, and every other built-in provider. Security filtering, rate limiting, Monetization, observability, caching — all of it works automatically.
...
| **Monetization** | Pass `user: "..."` to meter, limit, and charge per user |
...
- [Blog: Connect a Local LLM to Cencori](/newsroom/connect-local-llm-to-cencori) — step-by-step walkthrough
- [BYOK](/docs/platform/byok) — use your own API keys with built-in providers
- [Monetization](/docs/platform/monetization) — meter and charge your users
