...
Credits are enforced before request execution on credit-gated tiers. This preflight currently also applies to BYOK requests, even though their Cencori usage charge is zero.
