...
BYOK requests still pass the current credit-balance preflight on credit-gated plans. A zero balance can therefore block a request even though its Cencori usage charge would be zero.
