...
- **Model Name**: Use any model ID supported in your Cencori dashboard (e.g., `gpt-4o`, `claude-sonnet-4.5`).

> [!NOTE]
> If a tool asks for an OpenAI **base URL**, use `https://api.cencori.com/v1`. Only use the full `https://api.cencori.com/v1/chat/completions` URL when the tool asks for a complete request endpoint.
...
4. Model ID: e.g., `claude-sonnet-4.5`
