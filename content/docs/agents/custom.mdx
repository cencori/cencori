...
> [!NOTE]
> Some tools append `/chat/completions` automatically, while others expect you to include it in the base URL. If connections fail, try setting the URL to `https://cencori.com/api/v1/chat/completions`.
