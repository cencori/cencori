...
2. Click **Usage Billing** in the left sidebar.
...
- **Block**: The API returns a `429` error with a clear message explaining which limit was hit. Your app should show the user a message like "You've reached your daily limit. Upgrade for more."
- **Throttle**: Requests slow down but still go through. Good for soft limits.
