...
Fetch metrics programmatically for your own internal dashboards using the Metrics API (`https://api.cencori.com/v1/metrics`):

```typescript
// fetch-analytics.ts
const response = await fetch(
  'https://api.cencori.com/v1/metrics?period=24h',
  {
    headers: {
