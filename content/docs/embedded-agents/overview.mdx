...
Requires `cencori@1.7.0` or later. The Python Embedded Agents SDK is prepared but not yet published; use the HTTP API and OpenAPI contract until its release is announced.
