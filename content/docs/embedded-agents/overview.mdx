...
Requires `cencori@1.7.1` or later for typed tenant-scoped sessions. The Python Embedded Agents SDK is prepared but not yet published; use the HTTP API and OpenAPI contract until its release is announced.
...
See the full contract in the [Embedded Agents OpenAPI specification](https://cencori.com/openapi/embedded-agents.json).
