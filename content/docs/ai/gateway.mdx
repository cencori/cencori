...
Create and manage project keys in the [dashboard](/dashboard). If authentication succeeds but routing fails with a provider configuration error, add provider access in **Project > Providers** or choose a model from an enabled provider.
