...
2.  **Base URL**: Set to `https://api.cencori.com/v1`.
...
var client = new OpenAIClient(
    ...
    new AzureKeyCredential("csk_...")
);

// 2. Make a request (standard OpenAI API)
var chatCompletionsOptions = new ChatCompletionsOptions()
{
    DeploymentName = "gpt-4o", // or "claude-sonnet-4.5"
    Messages =
    {
...
```java
OpenAiService service = new OpenAiService("csk_...", Duration.ofSeconds(30), "https://api.cencori.com/v1/");
...
2.  Set it to `https://api.cencori.com/v1`.
