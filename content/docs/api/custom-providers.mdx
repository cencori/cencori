...
> [!NOTE]
> For an overview of custom providers, model routing, and dashboard setup, see the [Custom Providers platform docs](/docs/platform/ai-gateway/custom-providers).
