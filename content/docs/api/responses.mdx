...
Searches Cencori's first-party hybrid web index and injects evidence-bearing results as context for the model. No external search-provider key is required.
