...
- **Production keys** (`csk_...`) - use these in live applications.
- **Test keys** (`csk_test_...`) - use these during development. Test keys have lower rate limits and don't incur charges.

### Environment Configuration

```bash
# .env.development
CENCORI_API_KEY=csk_test_abc123xyz456
```

```bash
# .env.production
CENCORI_API_KEY=csk_live_xyz789abc123
```
