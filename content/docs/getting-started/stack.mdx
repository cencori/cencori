...
<Cards>
  <Card title="Framework" icon="Layout">
    **Next.js**
    <br/>
  ...
  <Card title="Deployment" icon="Globe">
    **Vercel**
    <br/>
    The global edge network. Handles caching, serving, and scaling.
  </Card>
  ...
  <Card title="Intelligence" icon="Cencori">
    **Cencori**
    <br/>
...
<CardGroup cols={2}>
  <Card title="Supabase Guide" icon="Zap" href="/docs/integrations/supabase">
    Connect Auth & Database
  </Card>
  <Card title="Firebase Guide" icon="Flame" href="/docs/integrations/firebase">
