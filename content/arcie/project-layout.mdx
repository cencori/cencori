...
description: The agent/ directory convention — every slot, how it maps to the manifest, and the rules Arcie validates.
---

A framework-authored Arcie agent is a directory of well-known slots. Arcie **discovers** the slots
...
*directories*, each a small agent of its own (see [Subagents](/arcie/docs/subagents)).
