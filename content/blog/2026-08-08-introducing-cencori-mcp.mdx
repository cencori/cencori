...
coverImage: "/newsroom/images/covers/cencori-mcp.png"
authors: []
...
[Read the MCP documentation →](/docs/mcp) · [Explore Cencori Web →](/docs/api/web) · [View the package on npm →](https://www.npmjs.com/package/@cencori/mcp)
