...
slug: "sessions"
date: "2026-06-23"
coverImage: "/newsroom/images/covers/ses.png"
...
`web_search_preview` runs automatically on Cencori's first-party Web index. `send_email` triggers a pause, waiting for human approval. No extra infrastructure needed.
