...
Exact Match Cache Redis gives less than 10ms latency for instant cache hits. It uses SHA-256 hash of normalized prompt, is case-insensitive and whitespace-normalized, and is Redis-backed for speed.

Semantic Match Cache pgvector gives about 50ms latency for similarity search via embeddings. It finds semantically similar prompts, has configurable similarity threshold, and uses text-embedding-004 for vector embeddings.
