...
coverImage: "/blog/images/covers/cencori-web.svg"
authors: ["bola"]
...
And `@cencori/mcp@0.7.0` exposes `web_search`, `web_fetch`, `web_extract`, browser-job polling, crawling, browsing, and takedown requests to MCP clients.
