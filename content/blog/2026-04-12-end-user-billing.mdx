...
coverImage: "/newsroom/images/covers/enduser.png"
...
const quota = await fetch(
  `https://api.cencori.com/v1/billing/check-quota?end_user_id=${userId}`,
...
// After processing
await fetch("https://api.cencori.com/v1/billing/usage-events", {
  method: "POST",
  headers: {
