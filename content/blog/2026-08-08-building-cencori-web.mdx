...
coverImage: "/blog/images/covers/cencori-web-architecture.svg"
authors: ["bola"]
...
Developers can use the explicit TypeScript methods in `cencori@1.6.1`, raw HTTP endpoints, the Responses API's `web_search_preview` tool, or `@cencori/mcp@0.7.0`.
