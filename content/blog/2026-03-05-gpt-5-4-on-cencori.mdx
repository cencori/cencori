...
authors:
  - bola
tags: ["OpenAI", "GPT-5.4", "AI Models", "Update"]
category: "product"
published: true
---
...
- OpenAI-compatible routing normalization for GPT-5.4 alias compatibility
...
- If you rely on strict model pinning for long-running evals, keep your own pinned fallback policy.
