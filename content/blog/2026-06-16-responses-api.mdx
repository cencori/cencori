...
**Update, August 8, 2026:** `web_search_preview` now runs on [Cencori Web](/blog/introducing-cencori-web), our first-party crawler, corpus, hybrid index, and evidence layer. It no longer depends on a hosted search provider or a separate provider key.
