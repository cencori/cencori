import { StreamChunk, SummarizationOptions, SummarizationResult } from '../../types.js';
/**
 ...
 */
export interface SummarizeAdapter<TModel extends string = string, TProviderOptions extends object = Record<string, unknown>> {
 ...
 */
export declare abstract class BaseSummarizeAdapter<TModel extends string = string, TProviderOptions extends object = Record<string, unknown>> implements SummarizeAdapter<TModel, TProviderOptions> {
    readonly kind: "summarize";
    ...
    constructor(config: SummarizeAdapterConfig | undefined, model: TModel);
