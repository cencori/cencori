 ...
 */
export interface VideoAdapter<TModel extends string = string, TProviderOptions extends object = Record<string, unknown>> {
     ...
     */
    createVideoJob: (options: VideoGenerationOptions<TProviderOptions>) => Promise<VideoJobResult>;
    /**
 ...
 */
export declare abstract class BaseVideoAdapter<TModel extends string = string, TProviderOptions extends object = Record<string, unknown>> implements VideoAdapter<TModel, TProviderOptions> {
    readonly kind: "video";
    ...
    abstract createVideoJob(options: VideoGenerationOptions<TProviderOptions>): Promise<VideoJobResult>;
