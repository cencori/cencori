...
import { ArrowRight, ChevronRight, Landmark, Lock, FileDigit, GlobeLock } from "lucide-react";
        ...
        <div className="min-h-screen bg-background text-foreground">
            ...
            <main>
                <section className="relative flex flex-col items-center justify-center overflow-hidden bg-background pt-32 pb-20">
                    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-green-500/5 via-background to-background pointer-events-none" />
                    ...
                    <div className="container relative z-10 px-4 md:px-6 flex flex-col items-center text-center">
                        <div className="mb-8 animate-appear">
                            <span className="inline-flex items-center rounded-full border border-foreground/10 bg-foreground/5 px-3 py-1 text-sm font-medium text-foreground/80">
                                ...
                                <span className="mr-2">Financial Services</span>
                            </span>
                        </div>
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter mb-6 max-w-4xl animate-appear [animation-delay:100ms] text-transparent bg-clip-text bg-gradient-to-b from-foreground to-foreground/50">
                            Innovate in the <span className="italic">most regulated</span> markets
                        </h1>

                        <p className="text-lg md:text-xl text-muted-foreground max-w-xl mb-10 animate-appear [animation-delay:200ms] leading-relaxed">
                            Deploy AI with confidence. Cencori provides the controls you need for GLBA, SOX, and PCI compliance.
                        </p>
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                            <div className="p-6 border border-border/30 rounded-lg">
                                <FileDigit className="h-6 w-6 text-green-500 mb-4" />
                                <h3 className="font-semibold text-lg mb-2">Smart PII Redaction</h3>
                                <p className="text-sm text-muted-foreground">
                                    Automatically detect and redact credit card numbers, SSNs, and other sensitive financial data before it leaves your perimeter.
                                </p>
                            </div>
                            <div className="p-6 border border-border/30 rounded-lg">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Control where your data is processed. Flexible deployment options including VPC peering and on-premise.
                                </p>
                            </div>
                            <div className="p-6 border border-border/30 rounded-lg">
                                <GlobeLock className="h-6 w-6 text-slate-500 mb-4" />
                                <h3 className="font-semibold text-lg mb-2">Zero-Retention Mode</h3>
                                <p className="text-sm text-muted-foreground">
                                    Configure Cencori to process requests without storing any payload data, ensuring zero data footprint.
                                </p>
                            </div>
                        </div>
                    </div>
