        ...
        <div className="space-y-10">
            ...
            <section className="space-y-3">
                ...
                <div className="border border-border/40 rounded-lg divide-y divide-border/40">
                    ...
                    {/* Mobile: title + toggle on first row, description below */}
                    {/* Desktop: title, description, toggle all inline */}
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-4 px-4 py-3">
                        {/* Mobile layout */}
                        <div className="flex items-center justify-between gap-2 sm:hidden">
                            <span className="text-sm font-medium">Dark Mode Native</span>
                            <div className="flex w-fit rounded-full border border-border/40 bg-muted/30 shrink-0">
                                <button
                        ...
                        <span className="text-xs text-muted-foreground sm:hidden">Design dark first, adapt for light. Try switching!</span>

                        {/* Desktop layout - all inline */}
                        <div className="hidden sm:flex sm:items-baseline sm:gap-4 sm:flex-1">
