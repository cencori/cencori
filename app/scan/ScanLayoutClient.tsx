...
interface ScanLayoutClientProps {
    children: ReactNode;
}
...
export default function ScanLayoutClient({ children }: ScanLayoutClientProps) {
    ...
    return (
        <div className={`${GeistSans.className} ${GeistMono.variable} flex h-screen w-full flex-col`}>
            {/* Navbar */}
