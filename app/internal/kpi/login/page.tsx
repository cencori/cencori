            ...
            <div className="w-full max-w-xs space-y-6">
                ...
                <div className="border border-border/40 rounded-lg bg-card/50 p-4 space-y-4">
                    <div className="space-y-1 text-center">
                        <h1 className="text-sm font-medium">Internal Dashboard</h1>
                        <p className="text-[11px] text-muted-foreground">Sign in to view KPIs</p>
                    </div>
                    ...
                    <p className="text-center text-[10px] text-muted-foreground">
                        Need access?{" "}
                        <Link href="/internal/kpi/signup" className="text-foreground hover:underline">
                            Create account
                        </Link>
                    </p>
                </div>
