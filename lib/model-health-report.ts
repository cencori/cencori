...
//   avgLatencyMs: number;
//   uptime: number; // 0-100
//   incidentCount: number; // number of 'unavailable' checks in the week
// }
...
// // ── Prompt builder ───────────────────────────────────────────────
// // Exported so tests can verify the prompt without calling Gemini
...
//   // 1. Fetch last 7 days of health checks for this project
...
//     return NO_DATA; // no data — skip Gemini call
//   }

//   // 2. Group by model and compute per-model stats
...
//   try {
//     // 3. Call Gemini with the summarised data
